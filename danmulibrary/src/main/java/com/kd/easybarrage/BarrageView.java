...
public class BarrageView extends RelativeLayout {
    ...
    private void showBarrage(final Barrage tb) {
        ...
        textView.setBackgroundDrawable(tintDrawable(drawable, Color.TRANSPARENT));
        ...
        textView.setTextColor(random_color ? Color.rgb(random.nextInt(256), random.nextInt(256), random.nextInt(256)) : tb.getColor());
